...
Well Javascript applies hoisting only to function declaration using `function` keyword, it __doesn't apply hoisting to an arrow function__ `const someFunc => {}`. 
